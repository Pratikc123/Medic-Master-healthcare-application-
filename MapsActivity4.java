 ...
 */
 ...
 mMap.addMarker(new MarkerOptions().position(syddney).title("Nucleus Diagnostic
 Center"));
  mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
 51
  mMap.addMarker(new MarkerOptions().position(ab).title("SonoScan Diagnostic
 Center"));
  ...
  mMap.addMarker(new MarkerOptions().position(ty).title("Abhinav Kidney Dialysis
 And Health Center "));
  ...
  mMap.addMarker(new MarkerOptions().position(sy).title("Akshar Diagnostic
 Center"));
